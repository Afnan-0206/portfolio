      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-14 lg:grid-cols-[1.15fr_0.85fr] items-start">
          ...
          >
            ...
            <div className="space-y-4 text-base sm:text-lg leading-relaxed text-[#A1A1AA]">
              <p>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#121316] p-6 shadow-card space-y-4">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <span className="font-mono text-[11px] font-bold tracking-wider text-[#E2B36E] uppercase">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                {HIGHLIGHTS.map((fact) => {
                  ...
                  return (
                    <div
                      key={fact.label}
                      className="flex items-start gap-3 rounded-xl border border-white/5 bg-[#17181D] p-3.5 transition-colors hover:border-white/15"
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="font-mono text-[10px] font-bold tracking-wider text-[#71717A] uppercase">
                          {fact.label}
                        </p>
                        <p className="text-sm font-semibold text-[#F4F4F5] mt-0.5 leading-snug">
                          {fact.value}
                        </p>
                      </div>
                    </div>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#121316] p-4 shadow-card group transition-all duration-300 hover:border-white/20">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-white/5 bg-[#17181D]">
                ...
                <div className="absolute top-3 left-3">
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-[#090A0C]/85 px-3 py-1 font-mono text-[10px] font-bold text-[#E2B36E] uppercase backdrop-blur-md">
                ...
                <div className="absolute bottom-3 inset-x-3 flex items-end justify-between gap-3">
                  <div>
                    <p className="text-sm font-bold text-[#F4F4F5] tracking-tight">Afnan B.R.</p>
                    <p className="text-[11px] text-[#A1A1AA] font-mono mt-0.5">
                      AgentsNexus · Scaler Buildathon
                    </p>
                  </div>
                  <div className="flex items-center gap-1 rounded-full bg-[#10B981]/15 border border-[#10B981]/30 px-2.5 py-1 text-[10px] font-mono font-semibold text-[#10B981] backdrop-blur-md">
            ...
            {PRINCIPLES.map((p) => {
              ...
              return (
                <div
                  key={p.id}
                  className="rounded-2xl border border-white/10 bg-[#121316] p-6 backdrop-blur-sm shadow-card transition-all duration-300 hover:border-white/20"
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-[#17181D] text-[#E2B36E]">
                      <Icon size={18} />
                    </div>
                    <h3 className="text-base font-bold text-[#F4F4F5]">{p.title}</h3>
                  </div>
