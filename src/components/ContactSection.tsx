...
export default function ContactSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const subjectText = form.subject.trim() || `Portfolio Inquiry from ${form.name.trim()}`;
            ...
            <AnimatePresence mode="wait">
              {status === "success" ? (
                <motion.div
                  ...
                  className="rounded-xl border border-[#10B981]/30 bg-[#10B981]/10 p-6 sm:p-8 text-center space-y-4"
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#10B981]/20 text-[#10B981] mx-auto">
                    <CheckCircle2 size={28} />
                  </div>
                  <h4 className="text-lg font-bold text-[#F4F4F5]">Gmail Compose Ready!</h4>
                  <p className="text-xs text-[#A1A1AA] max-w-sm mx-auto leading-relaxed">
                    Your email draft has been generated with your details. Review and click <strong className="text-[#F4F4F5]">Send</strong> in Gmail to deliver your message directly to Afnan.
                  </p>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-[#E2B36E] px-4 py-2.5 text-xs font-bold text-[#0D0F12] hover:bg-[#F3CCA0] transition"
                    >
                      <Mail size={14} />
                    ...
                    <a
                      ...
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-[#17181D] px-4 py-2.5 text-xs font-semibold text-[#F4F4F5] hover:bg-[#1D1E24] transition"
                    >
                  ...
                  <button
                    ...
                    className="mt-2 text-xs text-[#71717A] hover:text-[#A1A1AA] transition underline block mx-auto"
                  >
                    Send another note
                  </button>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      id="contact-subject"
                      type="text"
                      placeholder="e.g. AI Workflow Collaboration / Project"
                      value={form.subject}
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#F4F4F5] py-3.5 text-xs font-bold text-[#090A0C] shadow-sm transition hover:bg-[#FFFFFF] hover:shadow-warm-glow"
                  >
                    <Send size={14} />
                    <span>Send via Gmail</span>
                  </button>
                  <p className="text-[11px] text-center text-[#71717A]">
                    Opens directly in Gmail compose with your message pre-filled
                  </p>
                </form>
              )}
            </AnimatePresence>
